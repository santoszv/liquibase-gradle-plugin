...
class LiquibaseRunner(private val project: Project, private val command: LiquibaseCommandEnum, private val parameters: LiquibaseParameters) : Runnable {
    ...
    override fun run() {
        when (command) {
            ...
            LiquibaseCommandEnum.Update -> update()
            LiquibaseCommandEnum.UpdateCount -> updateCount()
            LiquibaseCommandEnum.UpdateSQL -> updateSQL()
            LiquibaseCommandEnum.UpdateCountSQL -> updateCountSQL()
            // Database Rollback Commands
            LiquibaseCommandEnum.Rollback -> rollback()
            //LiquibaseCommandEnum.RollbackToDate -> rollbackToDate()
            LiquibaseCommandEnum.RollbackCount -> rollbackCount()
            LiquibaseCommandEnum.RollbackSQL -> rollbackSQL()
            //LiquibaseCommandEnum.RollbackToDateSQL -> rollbackToDateSQL()
            LiquibaseCommandEnum.RollbackCountSQL -> rollbackCountSQL()
            //LiquibaseCommandEnum.FutureRollbackSQL -> futureRollbackSQL()
            //LiquibaseCommandEnum.UpdateTestingRollback -> updateTestingRollback()
            LiquibaseCommandEnum.GenerateChangeLog -> generateChangeLog()
            // Documentation Commands
            LiquibaseCommandEnum.Doc -> dbDoc()
            // Maintenance Commands
            LiquibaseCommandEnum.Tag -> tag()
            LiquibaseCommandEnum.TagExists -> tagExists()
            LiquibaseCommandEnum.Status -> status()
            LiquibaseCommandEnum.Validate -> validate()
            LiquibaseCommandEnum.ChangelogSync -> changelogSync()
            LiquibaseCommandEnum.ChangelogSyncSQL -> changelogSyncSQL()
            //LiquibaseCommandEnum.MarkNextChangeSetRan -> markNextChangeSetRan()
            LiquibaseCommandEnum.ListLocks -> listLocks()
            LiquibaseCommandEnum.ReleaseLocks -> releaseLocks()
            LiquibaseCommandEnum.DropAll -> dropAll()
            LiquibaseCommandEnum.ClearCheckSums -> clearCheckSums()
        }
    }
